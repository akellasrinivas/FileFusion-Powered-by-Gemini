...
def get_file_text(file):
    ...
    if file.name.endswith('.pdf'):
        ...
        return extract_ppt_text(file)  # Support for .ppt format
...
def user_input(user_question):
    ...
    # Print the reply under the "Reply" heading
    st.markdown("### Reply:")
...
def main():
    ...
    st.header("📂 FileFusion-Powered-by-Gemini 💬")
    st.subheader("Chat and interact with your documents powered by Gemini AI 🤖")

    user_question = st.text_input("Ask a Question based on the Uploaded Documents", key="user_question")
    if user_question:
